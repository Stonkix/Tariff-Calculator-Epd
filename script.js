...
const CONSTANTS = {
    KEYS: {
        tariffs: [
            "1С-ЭПД 600 документов", "1С-ЭПД 1 000 документов","1С-ЭПД 2 000 документов",
            "1С-ЭПД 3 000 документов",  "1С-ЭПД 4 000 документов", "1С-ЭПД 5 000 документов", 
            "1С-ЭПД 7 000 документов", "1С-ЭПД \n10 000 документов", "1С-ЭПД \n20 000 документов", "1С-ЭПД \n30 000 документов",  
            "1С-ЭПД \n50 000 документов\n", "1С-ЭПД \n100 000 документов\n", "1С-ЭПД \n200 000 документов\n",
    ...
    LIMITS: [600, 1000, 2000, 3000, 4000, 5000, 7000, 10000, 20000, 30000, 50000, 100000, 200000, 300000, 500000, 1000000, 1500000, 2000000, 3000000, 5000000],
